				...
				<div className="row align-items-center">
					<div className="col-lg-5 wow fadeInLeft" data-wow-duration="2s" data-wow-delay="0.2s">
						<div className="section-head style-3 mb-4">
							<h6 className="sub-title text-primary bgl-primary m-b15">WHAT WE PROVIDE</h6>
							<h2 className="title">Simplify life with the power of artificial intelligence and machine learning</h2>
						</div>
						<p>Handle your  Business, Office, Houshold task from anywhere any time.<br/>
						We improve your quality of life with  our artificial intelligence and machine learning embedded decentralized apps.</p>
						<p className="m-b30">Automate your processes now with our solution.Faster processes and shorter client wait times – that's the brilliance of AI-powered automation.Use AI for insight into content and processes. Prioritize tasks to make better decisions.</p>
					</div>
					...
					<div className={`${open === "p1" ? "icon-bx-wraper style-3 left box-hover m-r100 m-b30 wow fadeInRight active" : "icon-bx-wraper style-3 left box-hover m-r100 m-b30 wow fadeInRight"}`} onMouseOver={() => setOpen("p1")}>
							...
							<div className="icon-content">
								...
								<p>  We forge digital products and online experiences rooted in user expectations and data to ultimately help our partners grow, innovate, and exceed their business objectives.</p>
							</div>
						</div>
						<div className={`${open === "p2" ? "icon-bx-wraper style-3 left box-hover m-l100 m-b30 wow fadeInRight active" : "icon-bx-wraper style-3 left box-hover m-l100 m-b30 wow fadeInRight"}`} onMouseOver={() => setOpen("p2")}>
							...
							<div className="icon-content">
								...
								<p>Revise and optimize your Office work processes, reduce your time and effort with our cross-functional solution.</p>
							</div>
						</div>
						<div className={`${open === "p3" ? "icon-bx-wraper style-3 left box-hover m-r100 m-b30 wow fadeInRight active" : "icon-bx-wraper style-3 left box-hover m-r100 m-b30 wow fadeInRight"}`} onMouseOver={() => setOpen("p3")}>
							...
							<div className="icon-content">
								...
								<p> We provide Sustainable energy solution for your home. 
									And allows you to operate, schedule, monitor appliances from anywhare .</p>
							</div>
						</div>
					</div>
				</div>
