					...
					<div className="col-xl-3 col-lg-3 col-sm-6 wow fadeIn" data-wow-duration="2s" data-wow-delay="0.8s">
						<div className="widget widget_services">
						   <h5 className="footer-title">Other links</h5>
							<ul>
								<li><a href="https://office.techkite.org/contact-us/">Contact For Office</a></li>
								<li><a href="https://business.techkite.org/contact-us/">Contact For Business </a></li>
								<li><a href="https://home.techkite.org/contact-us/">Contact For Home</a></li>
            ...
            <div className="container">
                <div className="row align-items-center">
                    <div className="col-lg-6 col-md-7 text-left"> 
						<span className="copyright-text">Copyright © 2022 <a href="https://techkite.org/" target="_blank">Techkite</a>. All rights reserved.</span> 
					</div>
