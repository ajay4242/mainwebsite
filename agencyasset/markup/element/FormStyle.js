				...
				<div className="container">
					<div className="row">
						<div className="col-lg-5 col-md-5 content-inner chosesus-content text-white">
							...
							<h3 className="font-weight-500 m-b50 op6 " >By 700+ customers for 200+ Web and Mobile App development projects.</h3>
						...
						<div className="col-lg-7 col-md-7 m-b30">
							<form className="inquiry-form  dzForm"  action="script/contact.php">
								...
								<p>Tell us a bit about you, your brand, and the project you have in mind.</p>
								<div className="row">
									...
									<div className="col-lg-6">
										<div className="form-group">
											<div className="input-group">
												...
												<input name="dzOther[Subject]" type="text" required className="form-control" placeholder="Addrss" />
											</div>
										</div>
									</div>
									<div className="col-lg-6">
									...
									<div className="col-lg-12">
										<div className="form-group">
											<div className="input-group">
												...
												<textarea name="dzMessage" rows="4" className="form-control" required placeholder="Tell us about your project or idea. eg. What do you love? What do you hate? Who is your biggest competitor? What’s your budget?"></textarea>
											</div>
										</div>
									</div>
									<div className="col-lg-12">
