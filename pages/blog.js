    ...
    <>
      ...
      <div className="page-content bg-white">
        ...
        <div
          ...
          style={{ backgroundImage: "url(images/banner/pic1.jpg)" }}
        >
          <div className="container">
            <div className="dlab-bnr-inr-entry">
              <h1>Blog</h1>
              <h2 style={{ color: "red" }}>
                Our blog is where we share our industry insights, innovative
                ideas and exciting announcements.
              </h2>
              {/* <!-- Breadcrumb Row --> */}
                  ...
                  <div className="dlab-info">
                    <h4 className="dlab-title">
                      <Link href="/blog-details-1">
                        <a>The Increasing Importance of Web Accessibility.</a>
                      </Link>
                    </h4>
                    <p className="m-b0">
                      When businesses look into website accessibility, they
                      usually investigate their front-end development or the
                      visible part of a website design. A step beyond making
                      digital content accessible is making the content
                      management system (CMS) of a website ready to use by
                    ...
                    <div className="dlab-meta meta-bottom">
                      <ul>
                        ...
                        <li className="post-author">
                          <i className="flaticon-user m-r10"></i>By Aryan Tomer
                        </li>
                  ...
                  <div className="dlab-info">
                    ...
                    <div className="dlab-meta meta-bottom">
                      <ul>
                        ...
                        <li className="post-author">
                          <i className="flaticon-user m-r10"></i>By Sorabh Kumar
                        </li>
                        <li className="post-comment">
                          <a href="javascript:void(0);">
                            <i className="flaticon-speech-bubble"></i>
                  ...
                  <div className="dlab-info">
                    <h4 className="dlab-title">
                      <Link href="/blog-details-3">
                        <a>Why Smarter Homes are the Future.</a>
                      </Link>
                    </h4>
                    <p className="m-b0">
                      ...
                      machine to machine through networks.
                    </p>
                    <div className="dlab-meta meta-bottom">
                      <ul>
                        <li className="post-date">
                        ...
                        <li className="post-author">
                          <i className="flaticon-user m-r10"></i>By Prabhas Singh
                        </li>
                        <li className="post-comment">
                          <a href="javascript:void(0);">
                            <i className="flaticon-speech-bubble"></i>
                ...
                <aside className="side-bar sticky-top">
                  ...
                  <div className="widget widget_archive">
                    ...
                    <ul>
                      ...
                      <li>
                        <a href="javascript:void(0);">
                          Ofiice Managementr<span>20</span>
                        </a>
                      </li>
                      <li>
                        <a href="javascript:void(0);">
                    ...
                    <div className="widget-post-bx">
                      ...
                      <div className="widget-post clearfix">
                        ...
                        <div className="dlab-info">
                          ...
                          <div className="dlab-meta">
                            <ul>
                              <li className="post-date"> 1 March, 2022 </li>
                            </ul>
                          </div>
                        </div>
                      </div>
                      <div className="widget-post clearfix">
                        ...
                        <div className="dlab-info">
                          ...
                          <div className="dlab-meta">
                            <ul>
                              <li className="post-date"> 7 February, 2020 </li>
                            </ul>
                          </div>
                        </div>
                      </div>
